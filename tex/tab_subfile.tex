...
\centering
\end{subtable}
% \caption[Subtables, a good and bad table.]
% \caption{Example of subtables. Remember in the code, the  \verb|\caption{}| needs to come before the \verb|\label{}| command. Don't ask me why, it just does. This goes for both the figure as a whole, as well as each of the subfigures.}
